...
import com.boutline.sports.helpers.AppRate;
...
public class MeActivity extends Activity {
    ...
    @InjectView(R.id.meToolbarTextView)
    TextView meToolbarTextView;
    ...
    @OnClick(R.id.meToolbarTextView)
    void openProfileSettings() {
        meToolbarTextView.setTextColor(Color.parseColor("#DDDDDD"));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        meToolbarTextView.setTextColor(Color.parseColor("#000000"));
        ...
        meToolbarTextView.setTypeface(defaultFont);
