...
public class FavoriteSportsActivity extends Activity {
    ...
    void onDone()
    {
        Intent i = new Intent(FavoriteSportsActivity.this, FavoritesActivity.class);
        startActivity(i);
        finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        /* this file is yet to be designed completely */
