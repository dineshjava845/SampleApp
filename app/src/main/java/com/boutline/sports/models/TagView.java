...
import com.boutline.sports.helpers.Constants;
import com.boutline.sports.helpers.OnTagClickListener;
import com.boutline.sports.helpers.OnTagDeleteListener;
import com.boutline.sports.helpers.Utils;
...
public class TagView extends RelativeLayout {
	...
	private void drawTags() {
		...
		for (Tag item : mTags) {
            ...
            Typeface defaultFont = Typeface.createFromAsset(this.getContext().getAssets(), "fonts/avonixorp.ttf");
            tagView.setTypeface(defaultFont);
            ...
            defaultFont = Typeface.createFromAsset(this.getContext().getAssets(), "fonts/avonixorp.ttf");
            deletableView.setTypeface(defaultFont);
			if (tag.isDeletable) {
